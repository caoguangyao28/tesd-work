...
var material=[
    ...
    {src:"static.png?r=2",id:"static"},{src:"button.png?r=1",id:"button"},{src:"ticket.png?r=2",id:"ticket"},{src:"ticketNot.png",id:"ticketNot"},
    {src:"bag.png",id:"bag"},{src:"bagOpen.png?r=1",id:"bagOpen"},
...
var staticData={
    id:"static",
    point:[{x:32,y:24,oY:-100,delayIn:0},{x:90,y:660,oY:-300,delayIn:1050,delayOut:0},{x:230,y:340,oY:300,delayIn:850,delayOut:0},{x:150,y:690,oY:650,delayIn:900,delayOut:0},{x:430,y:182,oY:850,delayIn:900,delayOut:0}],
    frames:[
...
var bagOPenData={
    ...
    animations:{stand:0,openEnd:4,open:[1,4,"openEnd",.4,.3],close:{frames:[4,3,2,1],next:"stand",speed:.5}}
};
//初始化优惠券
var ticketData={
    x:0,y:0,
...
//初始文案数据
var textData={
    lottery:{des1:"今天还可以抽奖",des2:"次",data:{x:230,y:830,oY:790,width:280,height:50,background:"#cb1c2f",delayIn:800}},
